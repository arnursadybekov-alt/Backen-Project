...
- **Redis-cached leaderboard** with TTL-based invalidation
- **Adaptive difficulty** based on child performance history
- **Per-user rate limiting** on auth and exercise endpoints
- **Offline-ready content API** with ETags and cache headers
    """,
    docs_url="/docs",
    redoc_url="/redoc",
